...
#    Updated: 2023/09/29 15:50:02 by gd-harco         ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
C_FILES 		=	char/ft_isalnum.c	char/ft_isalpha.c	\
					...
					char/ft_tolower.c	cahr/ft_isspace.c	\
\
					io/ft_putchar_fd.c					io/ft_putendl_fd.c						\
					io/ft_putnbr_fd.c					io/ft_putstr_fd.c						\
					io/ft_dprintf.c						io/ft_printf.c							\
					io/ft_GetNextLine/get_next_line.c	io/ft_GetNextLine/get_next_line_utils.c	\
\
					list/ft_lstadd_back_bonus.c		list/ft_lstadd_front_bonus.c	\
					list/ft_lstclear_bonus.c		list/ft_lstdelone_bonus.c		\
					list/ft_lstiter_bonus.c			list/ft_lstlast_bonus.c			\
					list/ft_lstmap_bonus.c			list/ft_lstnew_bonus.c			\
...
\
					...
					memory/ft_memset.c	memory/ft_free_array.c	\
\
					numbers/ft_atoi.c	numbers/ft_itoa.c	\
					numbers/ft_atof.c						\
\
					str/ft_split.c		str/ft_free_split.c		str/ft_strchr.c		\
					str/ft_strcmp.c		str/ft_strdup.c			str/ft_strpdup.c	\
					str/ft_striteri.c	str/ft_strjoin.c		str/ft_strlcat.c	\
					str/ft_strlcpy.c	str/ft_strlen.c			str/ft_strmapi.c	\
